...
<body>
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="cat-cuenta.php"><span class="glyphicon glyphicon-cloud"></span>Catálogo Cuentas</a></li>
	...
	<div class="panel-body">
		<form action="" id="Cuenta_Form">
			<div class="col-md-8">
				<div class="form-group">
					<label for="intBanco">Banco</label>
					<select name="intBanco" id="intBanco" class="form-control"></select>
				</div>
			</div>
			<div class="col-md-8">
				<div class="form-group">
					<label for="strBanco">Cuenta</label>
					<input type="text" class="form-control" name="strCuenta" id="strCuenta" placeholder="Nombre de la Cuenta"/>
				</div>
			</div>     
			<input type="hidden" name="accion" id="accion" value="agregar-cuenta" />
			<div class="col-md-8">
